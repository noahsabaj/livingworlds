...
// GoodType is defined in lw_economics crate
// We use a placeholder type here to avoid circular dependencies
// The actual GoodType should be imported where this is used
pub type GoodType = String; // Placeholder - actual type in lw_economics

/// Social classes that exist in society
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub enum SocialClass {
    Nobility,       // Aristocrats, landowners
    Clergy,         // Religious leaders
    Merchants,      // Traders, business owners
    Artisans,       // Skilled craftsmen
    Farmers,        // Agricultural workers
    Laborers,       // Unskilled workers
    Soldiers,       // Military personnel
    Scholars,       // Academics, intellectuals
    Slaves,         // Unfree laborers (historical accuracy)
}
...
pub struct TradeTerms {
    pub goods: Vec<(GoodType, Fixed32)>, // GoodType is placeholder, actual in lw_economics
    pub duration: GameTime,
