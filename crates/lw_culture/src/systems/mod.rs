...
// use lw_simulation::components::individual::{Individual, MigrationEvent}; // TODO: Fix circular dep
use lw_economics::components::{GoodType, trade::TradeEvent};
...
pub fn calculate_culture_attractiveness(
    culture: &Culture,
    observer: &Entity // TODO: Should be Individual,
) -> Fixed32 {
    ...
    // TODO: Once observer is Individual instead of Entity, use personality.materialism
    let weights = (Fixed32::from_float(0.3), Fixed32::from_float(0.3), Fixed32::from_float(0.4));
...
// TODO: Individual type is in lw_simulation - need to resolve circular dependency
/*
...
// TODO: MigrationEvent type is in lw_simulation - need to resolve circular dependency
/*
...
/// Helper functions
// TODO: These helper functions also need Individual type
/*
