...
use bevy::prelude::*;
use lw_core::Fixed32;
use lw_economics::components::*;
use lw_economics::components::markets::MarketOrder;
use crate::components::simulation::*;
use lw_core::shared_types::{GameEvent, EventPriority};
...
pub fn execute_economic_emergence_phase(
    ...
    for (mut market, market_entity) in &mut markets {
        ...
        for transaction in transactions {
            ...
            // TODO: Create proper event bundle or event system
