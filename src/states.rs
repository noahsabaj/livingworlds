...
impl Plugin for StatesPlugin {
    fn build(&self, app: &mut App) {
        app
            ...
            .add_systems(
                OnEnter(GameState::WorldConfiguration),
                enter_world_configuration,
            )
            .add_systems(
                OnExit(GameState::WorldConfiguration),
                exit_world_configuration,
            )
            ...
            .add_systems(
                OnEnter(GameState::WorldGenerationFailed),
                enter_world_generation_failed,
            )
            .add_systems(
                Update,
            ...
            .add_systems(
                OnExit(GameState::WorldGenerationFailed),
                exit_world_generation_failed,
            )
