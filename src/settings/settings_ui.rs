                    ...
                    panel
                        ...
                        .with_children(|content| match current_tab.0 {
                            SettingsTab::Graphics => {
                                spawn_graphics_content(content, &temp_settings.0.graphics)
                            }
                            SettingsTab::Audio => {
                                spawn_audio_content(content, &temp_settings.0.audio)
                            }
                            SettingsTab::Interface => {
                                spawn_interface_content(content, &temp_settings.0.interface)
                            }
                            SettingsTab::Performance => spawn_performance_content(content),
                            SettingsTab::Controls => {
                                spawn_controls_content(content, &temp_settings.0.controls)
                            }
                        });
    ...
    parent
        ...
        .with_children(|content| {
            ...
            create_cycle_row(
                content,
                "Shadow Quality",
                settings.shadow_quality.as_str(),
