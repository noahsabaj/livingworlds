                                ...
                                FormField::Slider {
                                    ...
                                    field_container
                                        ...
                                        .with_children(|slider_container| {
                                            ...
                                            let slider_entity = slider_container
                                                .spawn((
                                                    Node {
                                                        width: Val::Percent(100.0),
                                                        height: Val::Px(30.0),
    ...
    pub fn settings_form(parent: &mut ChildSpawnerCommands) -> Entity {
        ...
        parent
            ...
            .with_children(|form| {
                ...
                for (label, value) in &[("Master Volume", 50.0), ("SFX Volume", 50.0)] {
                    form.spawn((
                        Node {
                            width: Val::Percent(100.0),
                            flex_direction: FlexDirection::Column,
                ...
                // Graphics sliders
                for (label, value) in &[("Brightness", 50.0), ("Contrast", 50.0)] {
                    form.spawn((
                        Node {
                            width: Val::Percent(100.0),
                            flex_direction: FlexDirection::Column,
