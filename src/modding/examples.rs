//! Example mod creation utilities
//!
//! This module provides functions to create example mods for demonstration
...
/// Create an example balance mod for demonstration purposes
