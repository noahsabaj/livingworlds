...
pub(super) static COLOR_PALETTES: LazyLock<TerrainColorPalettes> =
    LazyLock::new(|| TerrainColorPalettes::generate());
...
pub(super) fn compute_terrain_color(terrain: TerrainType, elevation: f32) -> Color {
    ...
    match terrain {
        ...
        TerrainType::TemperateDeciduousForest => {
            ...
            SafeColor::srgb(
                0.15 + deciduous_var * 0.5,
                0.4 + deciduous_var,
                0.12 + deciduous_var * 0.3,
            )
        }
        TerrainType::TemperateGrassland => {
            ...
            SafeColor::srgb(
                0.4 + grass_factor,
                0.65 + grass_factor * 0.5,
                0.3 + grass_factor * 0.3,
            )
        }
        TerrainType::ColdDesert => {
        ...
        TerrainType::TropicalRainforest => {
            ...
            SafeColor::srgb(
                0.02 + jungle_depth,
                0.28 + jungle_depth * 2.0,
                0.05 + jungle_depth * 0.5,
            )
        }
        TerrainType::TropicalSeasonalForest => {
            ...
            SafeColor::srgb(
                0.15 + seasonal_var,
                0.38 + seasonal_var * 0.5,
                0.08 + seasonal_var * 0.3,
            )
        }
        TerrainType::Savanna => {
        ...
        TerrainType::TropicalDesert => {
            ...
            SafeColor::srgb(
                0.95 + trop_desert * 0.3,
                0.85 + trop_desert * 0.2,
                0.55 - trop_desert * 0.5,
            )
        }
