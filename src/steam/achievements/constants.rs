//! Achievement ID constants for Living Worlds
//!
//! This module defines all Steam achievement identifiers and their display names.
//! Achievement IDs must match those configured in the Steamworks partner site.

/// Achievement IDs for Living Worlds Steam integration
